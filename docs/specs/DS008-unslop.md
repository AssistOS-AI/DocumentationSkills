...
The complete folder contains `SKILL.md` and `DS.md`, with no executable helper or declared dependency. The catalog, HTML page, and design summary must describe the descriptor without changing its editing rules or claiming a runtime it does not contain.
