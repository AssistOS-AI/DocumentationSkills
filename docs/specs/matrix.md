...
| [DS004-detect-main-behaviors](specsLoader.html?spec=DS004-detect-main-behaviors.md) | Analyzes a project to identify the small evidence-backed set of behaviors that define its primary purpose. |
| [DS005-gamp-specs](specsLoader.html?spec=DS005-gamp-specs.md) | Synchronizes onboarding, agent guidance, HTML documentation, and specifications, including an available default coding-style policy. |
