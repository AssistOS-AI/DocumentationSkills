...
### Question #1: Why is the summary separate from the rest of the message?

Response: The exact markers let a reader or consuming tool find the concise explanation without removing technical detail that may still be useful elsewhere in the response.
